...
(function() {
  describe('$._jQueryFormSerializer.regexp', function() {
    describe('simple', function() {
      beforeEach(function() {
        return this.regexp = $._jQueryFormSerializer.regexp.simple;
      });
    ...
    return describe('array', function() {
      beforeEach(function() {
        return this.regexp = $._jQueryFormSerializer.regexp.array;
      });
