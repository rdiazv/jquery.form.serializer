...
(function() {
  describe('$.jQueryFormSerializer.Serializer', function() {
    beforeEach(function() {
    ...
    describe('._serializeField(name, value)', function() {
      beforeEach(function() {
        return this.serializer = new $.jQueryFormSerializer.Serializer;
      });
    ...
    describe('._getSubmittableFieldValues(options)', function() {
      beforeEach(function() {
        return this.serializer = new $.jQueryFormSerializer.Serializer(this.$form);
      });
    ...
    return describe('.toJSON(options = {})', function() {
      ...
      return it('should pass the options to _getSubmittableFieldValues', function() {
        var options;
        this.sandbox.spy($.jQueryFormSerializer.Serializer.prototype, "_getSubmittableFieldValues");
        options = {
          option1: 1
        };
        this.serializer.toJSON(options);
        return expect($.jQueryFormSerializer.Serializer.prototype._getSubmittableFieldValues).to.have.been.calledWith(options);
      });
    });
  });
